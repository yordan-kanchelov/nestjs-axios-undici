...
- **With interceptors**, Fastify + Undici averages 28-83ms, still faster than every Axios configuration (54-129ms at best).
...
|---|---:|---:|---:|---:|
| Express + Axios | 138.26 | 132.43 | 115.17 | 55.59 |
| Fastify + Axios | 128.50 | 126.86 | 115.93 | 54.48 |
| Fastify + Undici | 41.53 | 43.20 | 37.84 | 15.74 |
| Express + Axios + Interceptor | 170.36 | 165.08 | 141.34 | 75.73 |
| Fastify + Axios + Interceptor | 152.40 | 149.03 | 136.24 | 70.24 |
| Fastify + Undici + Interceptor | 83.09 | 77.08 | 70.03 | 28.15 |

## P95 Response Time (ms)

| Configuration | Node 20 | Node 22 | Node 24 | Node 26 |
|---|---:|---:|---:|---:|
| Express + Axios | 238.29 | 225.03 | 199.33 | 95.15 |
| Fastify + Axios | 219.26 | 212.55 | 201.55 | 93.44 |
| Fastify + Undici | 72.89 | 75.44 | 66.02 | 26.89 |
| Express + Axios + Interceptor | 289.42 | 282.83 | 250.40 | 136.97 |
| Fastify + Axios + Interceptor | 268.95 | 260.79 | 240.68 | 123.98 |
| Fastify + Undici + Interceptor | 130.38 | 120.67 | 111.54 | 46.71 |

## Throughput (requests/s)

| Configuration | Node 20 | Node 22 | Node 24 | Node 26 |
|---|---:|---:|---:|---:|
| Express + Axios | 464 | 485 | 557 | 1153 |
| Fastify + Axios | 500 | 506 | 554 | 1176 |
| Fastify + Undici | 1536 | 1478 | 1685 | 4031 |
| Express + Axios + Interceptor | 377 | 389 | 454 | 847 |
| Fastify + Axios + Interceptor | 421 | 431 | 471 | 912 |
| Fastify + Undici + Interceptor | 770 | 830 | 913 | 2264 |
...
| Configuration | Node 20 | Node 22 | Node 24 | Node 26 |
|---|---:|---:|---:|---:|
| Express + Axios | 23.2% | 24.6% | 22.7% | 36.2% |
| Fastify + Axios | 18.6% | 17.5% | 17.5% | 28.9% |
| Fastify + Undici | 100.1% | 78.4% | 85.1% | 78.8% |
