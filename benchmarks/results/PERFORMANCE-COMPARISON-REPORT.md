...
**Best Performer:** Fastify + Undici averages **30.78ms** across all tested Node.js versions, **68-71% faster** than the Express + Axios baseline.
...
4. **Interceptors keep Undici ahead** - Fastify + Undici with interceptors is 34-45% faster than the best Axios configuration without interceptors
...
|---|---|---|---|
| Node 20 | Fastify + Undici | 42.75ms | 69.1% 🟢 |
...
|---|---|---|---|---|
| 1 | Fastify + Undici | 30.78ms | 53.92ms | 2344 |
| 2 | Fastify + Undici + Interceptor | 58.88ms | 94.86ms | 1297 |
| 3 | Fastify + Axios | 96.76ms | 169.46ms | 757 |
| 4 | Express + Axios | 99.58ms | 174.61ms | 714 |
| 5 | Fastify + Axios + Interceptor | 117.59ms | 208.41ms | 623 |
| 6 | Express + Axios + Interceptor | 127.37ms | 236.35ms | 563 |
...
|---|---|---|---|---|
| Fastify+Axios vs Express+Axios | 7.7% | 13.8% | -5.8% | -1.5% |
| Fastify+Undici vs Express+Axios | 69.1% | 71.5% | 67.6% | 69.1% |
| Fastify+Undici vs Fastify+Axios | 66.6% | 66.9% | 69.4% | 69.5% |
...
|---|---|---|---|---|---|
| Express + Axios | 22.8% | 22.0% | 35.6% | 30.8% | 27.8% |
| Fastify + Axios | 20.9% | 21.0% | 22.6% | 21.5% | 21.5% |
| Fastify + Undici | 97.0% | 65.4% | 89.3% | 98.7% | 87.6% |
...
|---|---|---|---|---|---|---|
| Node 20 | 138.47ms | 127.86ms | 42.75ms | 170.00ms | 154.52ms | 84.21ms |
...
| Node Version | Express + Axios | Fastify + Axios | Fastify + Undici | Express + Axios + Interceptor | Fastify + Axios + Interceptor | Fastify + Undici + Interceptor |
|---|---|---|---|---|---|---|
| Node 20 | 119.50ms | 113.78ms | 34.26ms | 146.50ms | 136.34ms | 74.17ms |
...
| Node Version | Express + Axios | Fastify + Axios | Fastify + Undici | Express + Axios + Interceptor | Fastify + Axios + Interceptor | Fastify + Undici + Interceptor |
|---|---|---|---|---|---|---|
| Node 20 | 232.89ms | 221.00ms | 74.67ms | 297.91ms | 264.29ms | 133.02ms |
...
| Node Version | Express + Axios | Fastify + Axios | Fastify + Undici | Express + Axios + Interceptor | Fastify + Axios + Interceptor | Fastify + Undici + Interceptor |
|---|---|---|---|---|---|---|
| Node 20 | 417.70ms | 237.86ms | 79.12ms | 531.53ms | 416.52ms | 143.10ms |
...
| Node Version | Express + Axios | Fastify + Axios | Fastify + Undici | Express + Axios + Interceptor | Fastify + Axios + Interceptor | Fastify + Undici + Interceptor |
|---|---|---|---|---|---|---|
| Node 20 | 464 | 502 | 1493 | 378 | 416 | 760 |
